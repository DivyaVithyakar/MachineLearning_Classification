...
param_grid = {
    ...
    'binarize': [0.0, 0.5, 1.0],  # Threshold for binarizing input
    'fit_prior': [True, False]  # Whether to learn class priors
}

# Initialize GridSearchCV
grid = GridSearchCV(estimator=BernoulliNB(), param_grid=param_grid, cv=5, refit=True, scoring='accuracy', n_jobs=-1, verbose=1)
